...
def create_layout(app):
	return html.Div(
                [ 
                    html.Div([Header_mgmt_bp(app, False, False, True, False)], style={"height":"6rem"}, className = "sticky-top navbar-expand-lg"),
                    		...
                    		html.Div(
                    			[
		                    		...
		                    		dbc.Row([
										...
										dbc.Col([
											dcc.Dropdown(options = [{'label':'Bundle Report', 'value':'Bundle Report'},
												{'label':'ACO Report)', 'value':'ACO Report'}],
												value = "Bundle Report",clearable = False,style={"font-size":"0.8rem","font-family":"NotoSans-Light"}),
...
def div_report_content(app):
	return html.Div(
			[
				html.Div(
					html.Embed(src=app.get_asset_url("provider-bundle-report.pdf"), width="100%", height="1150px")
				),
