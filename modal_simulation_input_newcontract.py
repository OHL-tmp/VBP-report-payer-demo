...
def input_session_newcontract():
	return dbc.ListGroup([
		# html.H1("Client Data Input", style={"color":yellow3, "font-size":"1.2rem","padding-top":"0.8rem", "padding-bottom":"1.5rem"}),
		dbc.Row(
			[
					...
					[
						...
						dbc.Row(
							[
								...
								dbc.Col(dbc.Button("\u25BC", size="sm", color='primary', style={"border-radius":"10rem"}, block=True, id = 'button-data-intake-collapse-gender-newcontract'), width=4)
						...
						html.Div(
							dbc.Collapse(
								[
									card_collapse_gender_newcontract()
									
								],id = 'data-intake-collapse-gender-newcontract', is_open = False,
						...
						html.Div(
							[
										...
										dbc.Col(
											[
												...
												dbc.Row(
													[
														dbc.Col(html.P("Expand"), width="auto"),
														dbc.Col(dbc.Button("\u25BC", id = 'button-data-intake-collapse-age-newcontract', size="sm", color='primary', style={"border-radius":"10rem"}, block=True), width=5),
													]
												),
								...
								html.Div(
									dbc.Collapse(
										[
											card_collapse_age_newcontract()
										],
										id = 'data-intake-collapse-age-newcontract', is_open = False,
			...
			[
				dbc.Col(
					[
						...
						# 		dbc.Col(dbc.Button("\u25BC", size="sm", color='primary', style={"border-radius":"10rem"}, id = 'button-data-intake-collapse-benefit-newcontract', block=True), width=2),
						# 		dbc.Col()
						# 	],
						# 	style={"padding":"1rem"}
						# ),
						...
						# 	dbc.Collapse(
						# 		[
						# 			card_collapse_tier_newcontract()
						# 		],
						# 		id = 'data-intake-collapse-benefit-newcontract', 
						# 		is_open = False,
			...
			[
				dbc.Col(
					[
						...
						dbc.Row(
							[
								dbc.Col(dbc.Input(value = "", bs_size="sm", persistence = True, persistence_type = 'session', style={"border-radius":"5rem","padding-left":"1rem","padding-right":"1rem","color":"#000","font-family":"NotoSans-Regular"})),
								# dbc.Col(
								# 		dcc.Upload(
								# 			id = 'upload-price',
								# 			children = html.Div([
			...
			[
				...
				html.Div([
					...
					dbc.Row([
						...
						dbc.Col(
							dbc.Button("\u25BC", size="sm", color='primary', style={"border-radius":"10rem"}, id = 'button-data-intake-collapse-month-newcontract', block=True),
							)
						], style={"padding-top":"0.5rem"}),
						...
						dbc.Row(
							[
								...
								dbc.Col(
									dbc.Collapse(
										[
											card_data_intake_collapse_rampup_newcontract()
										],
										id = 'data-intake-collapse-month-newcontract', 
										is_open = False,
...
def card_collapse_age_newcontract():
	return dbc.Card(
			[
				dbc.Row([
...
def card_collapse_gender_newcontract():
	return dbc.Card([
				dbc.Row([
...
def card_collapse_tier_newcontract():
	return dbc.Card(
			[
				dbc.Row([
...
def card_collapse_month_newcontract():
	return dbc.Card(
			[
				dbc.Row([
...
def download_template_newcontract():
	return html.A(
...
def card_data_intake_collapse_rampup_newcontract():
	cardbody = [dbc.Row([
