...
#    load_data()
    return html.Div(
                [ 
                    html.Div([Header_contract(app, False, False,True, False, False)], style={"height":"6rem"}, className = "sticky-top navbar-expand-lg"),
                        ...
                        dbc.CardBody(
                            [
                                dbc.Row(
                                    [
                                        dbc.Col(html.Img(src=app.get_asset_url("bullet-round-blue.png"), width="10px"), width="auto", align="start", style={"margin-top":"-4px"}),
                                        dbc.Col(html.H4("Plan's Cost/Provider's Revenue Projection", style={"font-size":"1rem", "margin-left":"10px"}), width=8),
