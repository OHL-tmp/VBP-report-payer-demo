...
def modal_simulation_input_aco():
	return html.Div([
	...
	return dbc.ListGroup([
		dbc.Row(
			[
				...
				dbc.Col(dbc.Button("update data", id = 'update-edit-assumption-aco',outline=True, color="dark", className="mr-1", style={"border-radius":"5rem","width":"8rem"}), style={"padding-top":"0.8rem", "padding-bottom":"1.5rem", "padding-left":"1.5rem", "padding-right":"1.5rem"}, width=2),
			],justify="end"
		),
						...
						html.Div(
								[
									dbc.Row(
										...
										# 	),
										dbc.Col(
											html.Div(id = 'output-claim-upload-aco', style={"text-align":"center","padding":"0.5rem","font-family":"NotoSans-Regular","font-size":"0.6rem"}),
											width=1
											)
										]
									)
...
#app.layout = modal_simulation_input_aco(app)
