    ...
    return dbc.Card(
                dbc.CardBody(
                    [
                        ...
                        dbc.Row(
                            [
                                dbc.Col(dcc.Graph(figure=domain_quality_bubble(df_domain_score),id='manager-figure-domainscore' ,clickData={'points': [{'customdata': 'Patient/Caregiver Experience'}]},style={"width":"100%","height":"100%"}), style={"padding":"1rem"}),
